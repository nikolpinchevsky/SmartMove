...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCreateAccount.setOnClickListener {
            ...
            if (name.isEmpty()) {
                etFullName.error = getString(R.string.error_enter_full_name)
    ...
    private fun registerUser(name: String, email: String, password: String) {
        ...
        btnCreateAccount.setText(R.string.btn_loading)
        ...
        RetrofitClient.api.register(request).enqueue(object : Callback<TokenResponse> {
            override fun onResponse(
                ...
                btnCreateAccount.setText(R.string.btn_create_account)
